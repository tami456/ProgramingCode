...
Stage::Stage(Player* player,Enemy* enemy) : mResourceManager(ResourceManager::GetInstance())
{
	mPlayer = player;
	mEnemy = enemy;
...
void Stage::ChangeStage(NAME type)
{
	...
	if (mEnemy != nullptr)
	{
		mEnemy->ClearCollider();
		mEnemy->AddCollider(mActivePlanet->GetTransform()->collider);
	}
